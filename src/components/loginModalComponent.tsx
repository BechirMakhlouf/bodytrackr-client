      ...
      {isOpen
        ? (
          <AnimatePresence>
            ...
            >
              <form
                className="relative flex flex-col p-16 cursor-default bg-white border bg-opacity-100 opacity-100 
                          justify-between border-white-grey rounded-[36px] custom-shadow text-black"
